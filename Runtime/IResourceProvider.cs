...
namespace ResourceManagement
{
    ...
    public interface IResourceProvider
    {
        ...
        IAsyncOperation<TObject> ProvideAsync<TObject>(IResourceLocation loc, IAsyncOperation<IList<object>> loadDependencyOperation)
        where TObject : class;
        ...
        bool CanProvide<TObject>(IResourceLocation loc)
        where TObject : class;
        ...
        /// <param name="loc">Location to release.</param>
        /// <param name="asset">Asset to unload.</param>
        bool Release(IResourceLocation loc, object asset);
    }
}
